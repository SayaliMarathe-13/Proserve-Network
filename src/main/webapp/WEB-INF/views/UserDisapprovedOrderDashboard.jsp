...
for (BookOrder filteredOrder : viewOrders) {
    if (contact.equals(filteredOrder.getContact())) 
    		{
            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                       <a href="/ProServe_Network/userOwnOrders"><i class="fa fa-clock-o orange_color"></i>My own Orders</a>

                     <li>
                        <a href="/ProServe_Network/userApprovedOrders"  aria-expanded="false" ><i class="fa fa-diamond purple_color"></i> <span>Approved Orders</span></a>
                     </li>
                     
                     <li>
                        <a href="/ProServe_Network/userDisapprovedOrders">
...
for (BookOrder order : filteredOrders) {
	if("disapproved".equals(order.getStatus())){
	%>
        <tr>

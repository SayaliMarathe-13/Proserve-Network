                    ...
                    <table class="table table-bordered">
                        <thead>
   						 ...
   						 for (ServiceProvider provider : pendingProviders) {
   							 ...
   							 if(provider.getStatus().equals("disapproved"))
   							 {
										%>
										<tr>
						    <td style="color: black;" style="color: black;"> <%= provider.getContact() %></td>
						    <td style="color: black;" style="color: black;"><%= provider.getName() %></td>
                             <td style="color: black;" style="color: black;"><%= provider.getAge() %></td>
                                <td style="color: black;" style="color: black;"><%= provider.getAddress() %></td>
                                 <td style="color: black;" style="color: black;"><%= provider.getPincode() %></td>
                               <td style="color: black;" style="color: black;"><%= provider.getArea() %></td>
                             <td style="color: black;" style="color: black;"><%= provider.getCity() %></td>
                              <td style="color: black;" style="color: black;"><%= provider.getLatitute() %></td>
                             <td style="color: black;" style="color: black;"><%= provider.getLongitude() %></td>
                              <td style="color: black;" style="color: black;"><%= provider.getEmail() %></td>

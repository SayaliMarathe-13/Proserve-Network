...
<div class="dashboard_inner">
	...
	%>
        <tr>
           ...
           <td><a href="<%= request.getContextPath() %>/approvedOrder/<%=order.getOid()%>"><button class="btn btn-approved" style="background-color: green;">Approved</button></a></td>
           <td><a href="<%= request.getContextPath() %>/disapprovedOrder/<%=order.getOid()%>"><button class="btn btn-approved" style="background-color: green;">Disapproved</button></a></td>
        </tr>
<%
    }
}

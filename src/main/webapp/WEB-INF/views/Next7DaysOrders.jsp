...
for (BookOrder filteredOrder : viewOrders) {
    Date orderDate = filteredOrder.getDate(); 
    if (orderDate != null && orderDate.compareTo(sevenDaysLater) <= 0 && contact.equals(filteredOrder.getServiceProviderContact())) {
...
<!DOCTYPE html>"src/main/webapp/WEB-INF/views/TodaysOrders.jsp"
<html lang="en">
   <head>
      <!-- basic -->
      <meta charset="utf-8">
